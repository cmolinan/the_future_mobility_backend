...
RSpec.describe Api::V1::ReservationsController, type: :controller do
    ...
    before(:all) do
        ...
        @reserv1 = Reservation.create(reserve_date: '2023-01-21 11:00', address: 'New York, USA', user_id: @user.id, vehicle_id: @vehicle1.id)
        @reserv2 = Reservation.create(reserve_date: '2023-02-12 09:30', address: 'Tokyo, Japan', user_id: @user2.id, vehicle_id: @vehicle3.id)
        @reserv3 = Reservation.create(reserve_date: '2023-01-14 10:45', address: 'Berlin, Germany', user_id: @user.id, vehicle_id: @vehicle2.id)
        @reserv4 = Reservation.create(reserve_date: '2023-01-31 12:15', address: 'Toronto, Canada', user_id: @user.id, vehicle_id: @vehicle4.id)
    end
